      ...
      .pipe(
        ...
        switchMap((term) =>
          term.length < this.minChars()
            ...
            : this.search()(term).pipe(catchError(() => of<TbiSearchSelectItem[]>([]))),
        ),
        takeUntilDestroyed(),
      )
      .subscribe((opts) => this.options.set(opts));
  }

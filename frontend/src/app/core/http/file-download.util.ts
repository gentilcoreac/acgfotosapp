...
/**
 * Dispara la descarga en el browser de una respuesta binaria (`ApiClient.getBlob`/`postBlob`):
 * object URL + anchor efímero + revoke. El nombre sale del `Content-Disposition` de la respuesta,
 * con `fallbackName` si el header no viene o no se puede parsear.
 */

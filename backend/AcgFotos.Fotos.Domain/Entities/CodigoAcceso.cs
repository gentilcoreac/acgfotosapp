...
/// <summary>
/// Código que la familia canjea para entrar a SU álbum (sin registro, ADR-02). Corto y legible
/// (se reparte como tarjeta/QR) pero con entropía suficiente; el canje está rate-limiteado.
/// Puede haber más de uno por álbum (reemplazo de un código comprometido sin perder el histórico).
/// </summary>

...
{
    public class ReConfirmarCuentaDto(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, string subject, string tenantName, string tenantColor, string tenantLogoUrl) 
